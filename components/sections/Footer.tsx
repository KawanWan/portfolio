        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400">
              Desenvolvedor apaixonado por criar soluções web inovadoras e escaláveis.
            </p>
          </div>
            ...
            <div className="flex gap-4">
              ...
              {social.whatsapp && (
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-green-600 transition-colors text-gray-300 hover:text-white"
                  aria-label="WhatsApp"
                >
