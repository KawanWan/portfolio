  ...
  return (
    <Section id="projects" title="Projetos" subtitle="Meu Portfólio" background="white">
      ...
      {selectedProject && (
        ...
        >
          <div
            className="bg-white dark:bg-gray-800 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl custom-scrollbar"
              ...
              {selectedProject.gallery && selectedProject.gallery.length > 0 && (
                <div className="mt-8 space-y-8">
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">
                    Galeria do Projeto <span className="text-sm font-normal text-gray-500">(Clique para ampliar)</span>
                  </h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {selectedProject.gallery.map((imgSrc, index) => (
                      <div
                        key={index}
                        className="relative h-48 w-full rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-900 cursor-zoom-in group"
      ...
      {selectedImage && (
        ...
        >
          <button
            className="absolute top-4 right-4 text-white/70 hover:text-white bg-black/50 hover:bg-white/20 rounded-full p-2 transition-all z-10"
            onClick={() => setSelectedImage(null)}
          >
