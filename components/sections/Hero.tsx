...
export default function Hero({ name, title, subtitle, social }: HeroProps) {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-gray-900 to-blue-950 text-white relative overflow-hidden">
      
      {/* Animated background */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-blue-900 rounded-full opacity-20 blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-cyan-900 rounded-full opacity-20 blur-3xl animate-pulse delay-1000"></div>
      </div>
          ...
          <div className="flex gap-6 justify-center items-center pt-8 animate-slide-up delay-400">
            {social.github && (
              <a
                ...
                className="text-gray-400 hover:text-white transition-all hover:scale-110 hover:text-sky-400"
                aria-label="GitHub"
              >
            ...
            {social.linkedin && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-all hover:scale-110 hover:text-blue-400"
                aria-label="LinkedIn"
              >
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
